        ...
        <div className='bg-[#FBFBFB] rounded-lg w-[48vw] h-[21vh] p-1'>
            <div className='flex w-full h-full overflow-hidden gap-1'>
                <div className='flex flex-col h-full w-1/2'>
                    ...
                    <div className='flex flex-col justify-between px-0.5 pt-1 w-full h-full'>
                            <p className='text-[13px] text-black drop-shadow-sm leading-tight line-clamp-3 text-ellipsis overflow-hidden'>XPTTE Welighl Lasting Crea</p>
                            <div className='flex'>
                                <span className='flex items-baseline leading-snug mr-3'>
